...
checklist_etp = {
    ...
    "Justificativa da Solução Escolhida": "Justificativa da Solução Escolhida|Justificativa Final|Justificativa Técnica|Justificativa do Cenário Escolhido|Justificativa da Solução Escolhida - Art 11|Justificativa",
